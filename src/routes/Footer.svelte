<script lang="ts">
	import KoFiLogo from '$lib/images/ko-fi-icon.png';
</script>

<footer class="py-6">
	<div class="flex flex-col md:flex-row gap-4 justify-between md:items-end">
		<div class="px-6 flex-1">
			<ul>
				<li class="my-2">
					<a href="https://github.com/Braweria/learn-web-dev">GitHub Repository</a>
				</li>
				<li class="my-2">
					<a href="https://www.linkedin.com/in/wiktoria-mielcarek/">LinkedIn</a>
				</li>
				<li class="my-2">
					<a href="https://twitter.com/braweria">Twitter</a>
				</li>
				<li class="my-2">
					<div class="rounded-md bg-light-red w-fit pr-3 pl-1 hover:opacity-80">
						<a href="https://ko-fi.com/braweria" class="flex flex-row items-center gap-4 font-bold">
							<img src={KoFiLogo} alt="Ko-fi" placeholder="blur" height={40} width={40} />{' '}
							Support Me on Ko-fi
						</a>
					</div>
				</li>
		...
		<div class="px-6 flex-1 md:text-right">
			<p class="text-sm text-light-grey">
				Created by{' '}
				<a href="https://github.com/braweria"> Wiktoria Van Harneveldt </a>
			</p>
			<p class="text-sm text-light-grey">
